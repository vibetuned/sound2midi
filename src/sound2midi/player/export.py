...
from sound2midi.beatgrid import BeatGrid as _BeatGrid
from sound2midi.beatgrid import sec_to_tick_fn as _sec_to_tick_fn
from sound2midi.beatgrid import tick_to_sec_fn as _tick_to_sec_fn
